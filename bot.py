...
class Bot(Client):
    ...
    async def start(self):
        ...
        if FORCE_SUB_CHANNEL1:
            try:
                ...
                self.LOGGER(__name__).info(
                    "\nBot Berhenti. Gabung Group https://t.me/ZoneDangerSex untuk Bantuan"
                )
                sys.exit()
        ...
        self.LOGGER(__name__).info(
            f"[🔥 BERHASIL DIAKTIFKAN! FSUB5BOT BY Rehansaputradewantoro🔥]\n\nBOT Dibuat oleh @{OWNER}\nJika @{OWNER} Membutuhkan Bantuan, Silahkan Tanyakan ke https://t.me/ZoneDangerSex"
        )
